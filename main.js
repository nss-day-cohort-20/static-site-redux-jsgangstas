 ...
 var products = [
 	{ name: "Baby Swiffer!",
 	  description: "Do you have a small child that just can't stop crawling around? Is it difficult to make the time to sweep those dirty floors? Then Baby Swiffer is the product for you! Baby Swiffer uses the best of both clothing and cleaning technology to create an amazing outfit that lets your child do the job of cleaning your floors! It's simple, just put your child in the Baby Swiffer and let them roam free! They won't even know that their being used for labor while you relax. The best part is, when they're done, simply wash the Baby Swiffer like you would any other article of clothing and it's good as new!",
 	  price: "$19.99!",
 	...
 	{ name: "Butter!",
 	  description: "It's Butter! Now in an easy to use stick!",
 	  price: "$19.99!",
 	...
 	{ name: "The Donald Chia!",
 	  description: "It's back! Now in the new Presidential Edition!* Whether you love him or hate him, the Donald Chia is the perfect gift and sure to become a conversation starter. Just apply the miracle seeds, water, and watch that hair grow! <br> *is not any different than standard edition",
 	  price: "$19.99!",
